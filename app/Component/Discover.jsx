...
export default function Discover() {
  ...
  <div className="w-full rounded-2xl overflow-hidden shadow-lg bg-[#2e2e2e] transform transition duration-300 hover:scale-105 cursor-pointer">
    <Image src={discover} alt="Art Category" className="w-full h-48 object-cover" />
  ...
  {/* Card 2 */}
  <div className="w-full rounded-2xl overflow-hidden shadow-lg bg-[#2e2e2e] transform transition duration-300 hover:scale-105 cursor-pointer">
    <Image src={discover2} alt="Collectibles Category" className="w-full h-48 object-cover" />
    <div className="bg-[#3B3B3B] p-4">
      <h4 className="font-semibold text-[22px] leading-[140%] capitalize text-white font-mono mb-2">
        Distant Galaxy
      </h4>
  ...
  {/* Card 3 */}
  <div className="w-full rounded-2xl overflow-hidden shadow-lg bg-[#2e2e2e] transform transition duration-300 hover:scale-105 cursor-pointer">
    <Image src={discover3} alt="Art Category" className="w-full h-48 object-cover" />
    <div className="bg-[#3B3B3B] p-4">
      <h4 className="font-semibold text-[22px] leading-[140%] capitalize text-white font-mono mb-2">
        Distant Galaxy
      </h4>
